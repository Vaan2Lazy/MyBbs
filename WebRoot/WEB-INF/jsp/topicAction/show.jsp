...
<div id="MainArea">
		...
		<div class="ForumPageTableBorder dataContainer" datakey="replyList">
			...
			<div class="ListArea">
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					...
					<tr><!-- 文章内容 -->
						<td valign="top" >
							<div class="Content" style="color:#000; font-size: 16px" >${topic.content}</div>
						</td>
					</tr>
					<tr><!--显示楼层等信息-->
				...
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					...
					<tr><!-- 文章内容 -->
						<td valign="top" align="center">
							<div class="Content" style="color:#000; font-size: 16px;">${content}</div>
						</td>
					</tr>
					<tr><!--显示楼层等信息-->
						<td class="Footer" height="28" align="center" valign="bottom">
	...
	<form action="reply_add.action" method="post" >
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				...
				<tr class="Tint" height="200">
					...
					<td valign="top" class="no_color_bg">
						...
						-->
						<%@ include file="/WEB-INF/jsp/public/ueditor.jspf" %>
					</td>
				</tr>
				<tr height="30" class="Tint">
