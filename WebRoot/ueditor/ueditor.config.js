...
window.UEDITOR_HOME_URL = "/bbs/ueditor/";
(function () {
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,savePath: ['upload1','update2','update3']     //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        , toolbars:[
            ['fullscreen', 
                ...
                'link', 'unlink', '|', 
                'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment','insertcode','|',
